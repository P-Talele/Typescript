"use strict";
let vicle = ["car", "bus", "train"];
let num = [23, 44, 56, 77];
let mixValue = ["prashant", 2333, "talele"];
let multiType = ["Schoole", "Train", 4534, "Mumbai"];
...
console.log("***************************************************");
const subject = ["English", "Marathi", "Math", "Physics", "Chemistry", "Biology"];
for (let intex in subject) {
    console.log(subject[intex]);
}
const copyArray = [...subject]; // this is spraind  operator
const SliceArray = copyArray.slice(1, 4); // it retrun array
